...
import ankushBanerjee from "../public/AnkushBanerjee.jpg";
              ...
              <div className="relative w-72">
                ...
                <div className="profile-picture overflow-hidden md:overflow-visible rounded-md md:shadow-2xl">
                  <Image
                    ...
                    height={1790}
                    priority
                    alt="Ankush Banerjee profile picture"
...
const educationInfo = [
  {
    ...
    subTitle: "Narula Institute of Technology | 2018 ~ 2022",
    list: [
  ...
  },
  {
    ...
    subTitle: "Consectetur adipiscing elit | 2015 - 2017",
    list: [
  ...
  },
  {
    ...
    subTitle: "Laboris nisi ut aliquip | 2019",
    list: ["Ex ea commodo consequat duis aute irure dolor"],
  },
];
